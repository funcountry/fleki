...
section_support:
  ...
  - locator: page 1 extracted text
    notes: 'The PDF text reads: Semantic knowledge graph smoke PDF. Source materials
      become topic knowledge with provenance.'
  ...
  - locator: native local image decode attempt plus direct binary header inspection
    notes: The viewer reported an IHDR CRC error while direct local inspection still
      showed a PNG signature and IHDR chunk bytes.
  ...
  - locator: save package corrupt PNG inspection
    notes: The PNG contributed runtime-limit evidence and preserved source provenance
      even though decoding failed.
    provenance_id: prov_agovdd67cp6pqrtytwur2io2iq
supersedes: []
---
